 ...
 * setSample() 함수를 전달 받아야 하는데
 * 그 경로가 여러겹으로 겹치는 현상이 발생 한다
 *
 * React에서  State를 사용한 코딩을 할때 매우 자주 발생하는 현상이다
 *
 * 이러한 현상을 막는 코딩을 하기 위하여
 * Redux라는 3rd 라이브러리를 사용하는데
